...
- Generally, before developing enhancements to this charm, you should consider
  [opening an issue ](https://github.com/canonical/prometheus-scrape-config-operator) explaining
  your use case.
...
```bash
$ juju deploy ./prometheus-scrape-config-k8s_ubuntu-20.04-amd64.charm
```
