...
At any given time there are three revisions of the Prometheus Scrape Config charm [available on CharmHub.io](https://charmhub.io/prometheus-scrape-config-k8s), for each of the following channels:
